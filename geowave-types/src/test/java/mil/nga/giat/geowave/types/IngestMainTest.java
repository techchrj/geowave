...
import mil.nga.giat.geowave.ingest.OperationCommandLineOptions;
 ...
 * 
 */
public class IngestMainTest
{
	private final static Logger LOGGER = Logger.getLogger(IngestMainTest.class);
