...
{
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HdfsFile\",\"namespace\":\"mil.nga.giat.geowave.ingest.hdfs\",\"fields\":[{\"name\":\"originalFile\",\"type\":\"bytes\",\"doc\":\"Original file data\"},{\"name\":\"originalFilePath\",\"type\":[\"string\",\"null\"],\"doc\":\"Original file path\"}],\"doc:\":\"Stores the original files from a local file system in HDFS\"}");
	...
	public static mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder newBuilder() {
		return new mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder();
	}

	/** Creates a new HdfsFile RecordBuilder by copying an existing Builder */
	public static mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder newBuilder(
			mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder other ) {
		return new mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder(
				other);
	}
	 ...
	 */
	public static mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder newBuilder(
			mil.nga.giat.geowave.ingest.hdfs.HdfsFile other ) {
		return new mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder(
				other);
	}
			...
			org.apache.avro.data.RecordBuilder<HdfsFile>
	{
		...
		private Builder() {
			super(
					mil.nga.giat.geowave.ingest.hdfs.HdfsFile.SCHEMA$);
		}
		...
		public mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder setOriginalFile(
				java.nio.ByteBuffer value ) {
			validate(
					fields()[0],
					value);
		...
		public mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder clearOriginalFile() {
			originalFile = null;
		...
		public mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder setOriginalFilePath(
				java.lang.CharSequence value ) {
			validate(
					fields()[1],
					value);
		...
		public mil.nga.giat.geowave.ingest.hdfs.HdfsFile.Builder clearOriginalFilePath() {
